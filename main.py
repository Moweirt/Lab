...
st.header("Анализ коэффициентов **_b_1_** и **_b_2_**")

st.markdown("Вычислить параметр")
...
if (lig == "Глицерин" or liq == "глицерин"):
    resp2_3 += 6
...
if (resp >= 8):
    ...
    if (resp == 10):
        st.ballons
        st.warning("Если вы любите рисковать попробуйте ввести ниже FLES")
