...
ch_rad = st.multiselect('Влияние массы на систему', ['Увеличивает период', 'Уменьшает период', "Увеличивает амплитуду", "Уменьшает амплитуду"])
ch_rig = st.multiselect('Влияние массы на систему', ['Увеличивает период', 'Уменьшает период', "Увеличивает амплитуду", "Уменьшает амплитуду"])
ch_vis = st.multiselect('Влияние массы на систему', ['Увеличивает период', 'Уменьшает период', "Увеличивает амплитуду", "Уменьшает амплитуду"])
