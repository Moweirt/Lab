...
st.markdown("**_Уравнение колебаний._** Колебания широко распространены в природе. В общем случае под колебаниями понимают движения, в том "
            ...
            "об окружающем мире.\n"
            "Несмотря на различную физическую природу колебаний, все они обладают некоторой общей сущностью,"
            ...
            "их параметров (например, амплитуды).\nЕсли уравнения, описывающие колебания, имеют вид линейных дифференциальных "
            ...
            "может возникнуть в двух случаях. В первом из них за счет внешней силы система выводится из состояния устойчивого"
...
def animate(i):
    ...
    y = np.exp(-v * x) * np.sin( 2 * np.pi * w * (x - 0.01 * i ) )
